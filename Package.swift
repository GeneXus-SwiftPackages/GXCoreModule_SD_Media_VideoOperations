...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-3.2.0-beta.16.xcframework.zip",
			checksum: "5a32516ea574529f41cb0e63ee0b100844f324c9e16a4857a9dcd9946bf31367"
		)
	]
)