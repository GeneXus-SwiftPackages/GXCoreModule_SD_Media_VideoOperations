...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "dc0ec6ac7aae64768036b2babb066c71666ccf1b79dacbac7e2a298e55ecd6d2"
		)
	]
)