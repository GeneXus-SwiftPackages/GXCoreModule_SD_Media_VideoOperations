...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-2.2.0-beta.24.xcframework.zip",
			checksum: "6ce71c9dac37e16fb5b4917f52096b84f69b5d281ad88520fef8ddaa47a8634f"
		)
	]
)