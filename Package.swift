...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "b11a8c3da08101d5edc728cc4d673c2c4b30e1762e577812da47e59b2064a579"
		)
	]
)