...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Media_VideoOperations-1.1.2.xcframework.zip",
			checksum: "6e4b773214a006f9900120aebb9a6c74f9af4b1a68e32d719d3ef58b5773d1d4"
		)
	]
)