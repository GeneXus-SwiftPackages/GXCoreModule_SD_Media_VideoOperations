...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-1.5.0-beta.18.xcframework.zip",
			checksum: "04964c79cda42ebf056f0079f89f1f5c9b41c34ec46c9b23b65816ebaf5c058f"
		)
	]
)