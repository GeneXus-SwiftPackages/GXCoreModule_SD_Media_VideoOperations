...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-5.0.0-rc.0.xcframework.zip",
			checksum: "028d961a3dd0051585ddc904ac7620ff0cab24cbea0b59d57c55f7c78bfc3e6d"
		)
	]
)