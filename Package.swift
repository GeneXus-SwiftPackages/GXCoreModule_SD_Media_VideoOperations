...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-4.0.0-beta.45.xcframework.zip",
			checksum: "13515e12280e70053c72929d2d7210517830eb2286de909a8c86ac9791f808cc"
		)
	]
)