...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Media_VideoOperations-1.1.3.xcframework.zip",
			checksum: "c5e1bdf396defd97e860cb27dd22f34deaa37792ff508b89ff8031494dab408d"
		)
	]
)