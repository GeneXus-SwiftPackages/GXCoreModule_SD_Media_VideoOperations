...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.6.0-rc.0.xcframework.zip",
			checksum: "daeb4eaaf03203cc219b65ccd39c1344fec83fd4b1298dd65b7193421144284c"
		)
	]
)