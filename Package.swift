...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-3.1.0-rc.3.xcframework.zip",
			checksum: "a2714c81a5be4b3a624f979495192b02117a7101c89f2ed05adf5e7d7d30acbb"
		)
	]
)