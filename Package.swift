...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.2.0-rc.25.xcframework.zip",
			checksum: "2de76835b998242f1394c8cf9a7326cb0bb43094634c1e9c3868ec7f08ed86e3"
		)
	]
)