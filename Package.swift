...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-3.2.0-beta.21.xcframework.zip",
			checksum: "a1f46a97eaf1e96d164932fde5fca4f8b7cead0e9f4300a01408abe8b448584c"
		)
	]
)