...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-3.0.0-rc.15.xcframework.zip",
			checksum: "60c1d1a0e4f6c57d90293c050c556b6f279832af6950c796afc3e85196de6f17"
		)
	]
)