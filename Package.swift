...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.4.0-rc.21.xcframework.zip",
			checksum: "622109f00027425a4697c317aae3e0968df2843f333e2f1372c8a61ed5d3f3d1"
		)
	]
)