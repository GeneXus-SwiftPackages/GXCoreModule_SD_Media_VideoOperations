...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-4.1.0-beta.6.xcframework.zip",
			checksum: "b1e23527ac5c92d87a6c9581b56a1d8548dffc1de72a4cb106616c3458979640"
		)
	]
)