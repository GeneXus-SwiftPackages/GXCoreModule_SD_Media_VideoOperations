...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-1.6.0-beta.1.xcframework.zip",
			checksum: "00c045977b298a1b324be9ffdcfd6042e04bd0421982c3825d4e58bc822be502"
		)
	]
)