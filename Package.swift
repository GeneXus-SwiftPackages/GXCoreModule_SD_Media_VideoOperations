...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Media_VideoOperations-4.2.0-beta.17.xcframework.zip",
			checksum: "d9e665b2d7b9160a0ee8e4eae79d5d2cc6376586a3f84560feb7b7040b2fe366"
		)
	]
)