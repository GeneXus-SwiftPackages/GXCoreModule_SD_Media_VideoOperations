...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Media_VideoOperations-3.2.0.xcframework.zip",
			checksum: "94a84163489474d4c3a39ec05f21ad6e393798d61f9345ceadb88601f4ada30b"
		)
	]
)