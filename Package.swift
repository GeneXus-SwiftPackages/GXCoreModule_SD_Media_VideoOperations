...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.4.0-rc.10.xcframework.zip",
			checksum: "3dc467a2b8caef247f98ad89af4f43aec4b550af4502bf2b252a4f16d866f2ae"
		)
	]
)