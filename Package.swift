...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.1.0-rc.5.xcframework.zip",
			checksum: "60a3d7428c14b266a31cd52d139b6c3a1420fb0ac5db212a78cf0d4a5e04e858"
		)
	]
)