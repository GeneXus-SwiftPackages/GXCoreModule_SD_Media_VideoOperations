...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Media_VideoOperations",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Media_VideoOperations-1.2.0-rc.15.xcframework.zip",
			checksum: "7be57cd57f836e8a453e67cf6ac2f1b22b55b1839f7e56a10c4886229927e0f7"
		)
	]
)